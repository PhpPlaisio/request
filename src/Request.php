 ...
 * @property-read string  $acceptContentType    The content types acceptable by the user agent as sent by the user
 *                agent.
 ...
 * @property-read bool    $isOptions            Whether this is an OPTIONS request.
...
interface Request
{
  ...
  //--------------------------------------------------------------------------------------------------------------------
  /**
   * Validates the request. A BadRequestException must be thrown if the request is invalid.
   */
